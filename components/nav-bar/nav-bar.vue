<template>
	<view>
		<view class="header" :class="{fixed:navFixed,absolute:type == 'transparent','line':navLine}" :style='{height: (44 + statusBarHeight)+"px",background: navBgColor,color:navFontColor,opacity:transparentValue}'>
			<view>
		...
		<view class="header transparentFixed fixed" v-if="type == 'transparentFixed'" :style='{height: (44 + statusBarHeight)+"px",color:navTransparentFixedFontColor,opacity:1 - transparentValue,zIndex:transparentValue < 0.3 ? 100 :90 }'>
			<view>
				<view class="left_info" v-if="back || $slots.left || firstPage && back">
